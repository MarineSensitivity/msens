...
get_species_by_feature(
  ...
  where        = "mrgid = 8442")
#> Error in httr2::req_perform(httr2::req_url_query(httr2::req_url_path_append(httr2::request("https://api.marinesensitivity.org"),     "species_by_feature"), schema.table = schema.table, where = where)): HTTP 500 Internal Server Error.
```
