...
Identify a zone layer by its geometry rather than by the release that
used it, so one Program Area is comparable across versions
...
Match taxa from APIs, especially World Register of Marine Species
(WoRMS)
...
- [`match_taxa()`](http://marinesensitivity.org/msens/reference/match_taxa.md)
...
- [`publish_pmtiles_from_gpkg()`](http://marinesensitivity.org/msens/reference/publish_pmtiles_from_gpkg.md)
...
- [`stac_dataset_collection()`](http://marinesensitivity.org/msens/reference/stac_dataset_collection.md)
  : Dataset Collection node

- [`stac_model_cell_item()`](http://marinesensitivity.org/msens/reference/stac_model_cell_item.md)
  : Model-surface Item for a (DuckDB-backed) dataset

- [`stac_root_catalog()`](http://marinesensitivity.org/msens/reference/stac_root_catalog.md)
  : Root Catalog node

- [`stac_sdm_props()`](http://marinesensitivity.org/msens/reference/stac_sdm_props.md)
  : Build the SDM properties block shared by Collections and Items

- [`stac_season_cog_item()`](http://marinesensitivity.org/msens/reference/stac_season_cog_item.md)
